package com.tiket.messagebroker.springbootkafkaconsumermongodb.config;
...
public class KafkaConfiguration {
	...
	//consume Json message
	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, Airline> airlineKafkaListenerFactory(){
